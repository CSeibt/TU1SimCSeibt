...
void optivalues_CapThickness() {
  ...
  struct Dataset {
   ...
   vector<Dataset> datasets = {
    {"14cm", {
      "CapThickness/absVollenergieansprechvermögen_14cm_exp.txt",
      "CapThickness/absVollenergieansprechvermögen_14cm_sim_1.5.txt",
      "CapThickness/absVollenergieansprechvermögen_14cm_sim_1.6.txt",
      "CapThickness/absVollenergieansprechvermögen_14cm_sim_1.7.txt"
    }},
    {"0cm", {
      "CapThickness/absVollenergieansprechvermögen_0cm_exp.txt",
      "CapThickness/absVollenergieansprechvermögen_0cm_sim_1.0.txt",
      "CapThickness/absVollenergieansprechvermögen_0cm_sim_1.5.txt",
      "CapThickness/absVollenergieansprechvermögen_0cm_sim_1.6.txt",
      "CapThickness/absVollenergieansprechvermögen_0cm_sim_1.7.txt"
    }}
  }; // */
